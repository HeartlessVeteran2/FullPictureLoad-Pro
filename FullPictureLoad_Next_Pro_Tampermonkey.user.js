// ==UserScript==
// @name 圖片全載Next Pro (Tampermonkey)
// @name:en Full Picture Load Next Pro (Tampermonkey)
// @name:zh-CN 图片全载Next Pro (Tampermonkey版)
// @version 2026.4.0-TM
// @description 支持寫真、H漫、漫畫的網站1000+，Tampermonkey優化版，無限滾動閱讀模式，ZIP打包下載
// @description:en Modern image batch downloader optimized for Tampermonkey - 1000+ sites, infinite scroll, ZIP packaging
...
// ============================================
// TAMPERMONKEY OPTIMIZED VERSION
// Features: GM_download, GM_notification, enhanced menu commands
// ============================================
